...
// Source: minesweepersvc/redis_storage.go
...
import (
	...
	minesweepersvc "github.com/tomiok/minesweeper-API/minesweepersvc"
	reflect "reflect"
)
...
func (mr *MockDBMockRecorder) GetGame(key interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetGame", reflect.TypeOf((*MockDB)(nil).GetGame), key)
}
...
func (mr *MockDBMockRecorder) Exists(key interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Exists", reflect.TypeOf((*MockDB)(nil).Exists), key)
}
...
func (mr *MockDBMockRecorder) FlushAll() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FlushAll", reflect.TypeOf((*MockDB)(nil).FlushAll))
}
